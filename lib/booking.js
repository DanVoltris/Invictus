...
export const DEFAULT_SETTINGS = {
  bays: DEFAULT_BAYS,
  // Opening hours are ASSUMED: the GolfBook sheet starts its day at 4:00 AM, so this
  // runs 4:00 AM to midnight, every day. Confirm with Invictus and adjust.
  hours: { 0: [4, 24], 1: [4, 24], 2: [4, 24], 3: [4, 24], 4: [4, 24], 5: [4, 24], 6: [4, 24] },
  slotStep: 30,
  minMins: 60,
  maxParty: 4,
  peakStartHour: 17,
  // Invictus charges a flat CA$20/hour, so every band is the same.
  rates: { weekdayOffPeak: 20, weekdayPeak: 20, weekendOffPeak: 20, weekendPeak: 20 },
